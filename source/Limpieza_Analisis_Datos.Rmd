...
A la hora de aplicar algunos tests estadísticos, se tendrá que tener en cuenta la normalidad y la homocedasticidad de las variables que se verá en el apartado siguiente. FALTA AÑADIR LOS GRUPOS DE DATOS.
...
# Diagrama de cajas Cholesterol - Heart attack
ggplot(heart_data,aes(x=heart_attack,y=sex, fill=heart_attack)) +
  ...
  # Título del gráfico
  ggtitle ("Box Plot Sex - Heart attack")+
