...
- No hay una diferencia significativa en la proporción de personas con azúcar en sangre baja o alta que han padecido un ataque al corazón, ya que el valor p del test de chi-cuadrado es muy grande (p-value = 0.7444). Véase en el siguiente gráfico:
...
- No hay una diferencia significativa en la proporción de personas de diferentes sexos con azúcar en sangre baja o alta, ya que el valor p del test de chi-cuadrado es muy grande (p-value = 0.5417). Véase en el siguiente gráfico:
...
- Hay una diferencia significativa en la proporción de personas con diferentes tipos de dolor de pecho que han padecido un ataque al corazón, ya que el valor p del test de chi-cuadrado es muy pequeño (p-value < 2.2e-16). Véase en el siguiente gráfico:
...
Las personas mayores no sufren más ataques, de hecho se ha observado que el rango de edad de más ataques al corazón se encuentra entre los 50 y 60 años de edad.
