...
g2 <- ggplot(heart_data,aes(x=sex,y=cholesterol, fill=sex)) +
  geom_boxplot() +
  # Barras de error
  stat_boxplot(geom = "errorbar",width = 0.25) + # Ancho
  # Etiqueta Eje x y leyenda
