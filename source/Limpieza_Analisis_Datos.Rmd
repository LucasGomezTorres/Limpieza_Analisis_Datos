...
ggplot(heart_data,aes(x=heart_attack,y=st_depression, fill=heart_attack)) +
  ...
  # Título del gráfico
  ggtitle ("Box Plot st_depression - Heart attack")+
...
g1 <- ggplot(data = heart_data, aes(x=age, fill=heart_attack)) + geom_histogram(binwidth =3)
g2 <- ggplot(data = heart_data, aes(x=age, fill=heart_attack)) + geom_histogram(binwidth = 3,position="fill") + ylab("Frecuencia")
...
theme(axis.text.x = element_text(angle = 90, hjust = 1))
g2 <- ggplot(data = heart_data, aes(x=sex, fill=heart_attack)) + geom_bar(binwidth = 3,position="fill") +
ylab("Frecuencia") +
theme(axis.text.x = element_text(angle = 90, hjust = 1))
grid.arrange(g1, g2, nrow = 1)
```
